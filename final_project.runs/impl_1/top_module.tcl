namespace eval ::optrace {
  variable script "X:/ec311_project_whackamole/final_project.runs/impl_1/top_module.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet X:/ec311_project_whackamole/final_project.runs/synth_1/top_module.dcp
