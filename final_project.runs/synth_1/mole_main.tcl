...
synth_design -top mole_main -part xc7a100tcsg324-1
...
write_checkpoint -force -noxdef mole_main.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file mole_main_utilization_synth.rpt -pb mole_main_utilization_synth.pb"  } 
