...
HD_PWD='X:/layton-sahler/sahler-layton/ec311_project_whackamole/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mole_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mole_main.tcl
